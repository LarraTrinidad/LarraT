#ifndef ABEDGERACKINGMODIFIER_HPP_
#define ABEDGERACKINGMODIFIER_HPP_
...
class AbEdgeTrackingModifier : public AbstractCellBasedSimulationModifier<DIM,DIM>
{
private:

    /**
     * Diffusion coefficient of unbound protein concentrations within the plasma 
     * membrane. Stored in this class, rather than in AbEdgeSrnModel or in 
     * AbEdgeOdeSystem, since it is only used in this class. Initialised to 
...
public:
     ...
     * Default constructor.
     */
    AbEdgeTrackingModifier();

    /**
     * Destructor.
     */
    virtual ~AbEdgeTrackingModifier();
...
#endif //ABEDGERACKINGMODIFIER_HPP_
