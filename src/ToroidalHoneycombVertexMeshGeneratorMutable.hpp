...
public:
     ...
     *     (defaults to 0.001)
     * @param elementArea the element area (defaults to 0)
     */
    ToroidalHoneycombVertexMeshGeneratorMutable(
    ...
    /**
     * @return a 2D honeycomb mesh with periodic left/right and top/bottom 
     *     boundaries
     */
