                                                            ...
                                                            VertexBasedCellPopulation<DIM>& rVertexCellPopulation)
{
    ...
    // Cell 1
    double interface_length_in_cell_1 = GetCombinedInterfaceLength(pNodeA, element1Index,  rVertexCellPopulation);

    // Cell 2
    double interface_length_in_cell_2 = GetCombinedInterfaceLength(pNodeA, element2Index,  rVertexCellPopulation);
        ...
        else
        {
          ...
          //  {
            ...
            //    }
                ...
                {
                    double scale_factor = GetCombinedInterfaceScaleFactor(pNodeA, pNodeB, elem_1_index, elem_2_index, rVertexCellPopulation);
