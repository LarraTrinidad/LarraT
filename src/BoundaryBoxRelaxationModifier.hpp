...
private:
    ...
    /** Stiffness of box. Initialised to 1000 in constructor. */
    double mStiffness;

    /** Pointer to force object. Initialised to nullptr in constructor. */
...
public:
    ...
    /**
     * @param relaxPeriodicBox: whether to allow the box to change shape to 
     *     dissipate stress.
     */
     ...
     */
    void SetForce(boost::shared_ptr<FarhadifarForce<2> > p_force);
    
    /**
     * Overridden OutputSimulationModifierParameters() method. Output any 
     * simulation modifier parameters to file.
     *
